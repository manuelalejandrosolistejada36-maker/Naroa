  ...
  return (
    <div className="bg-stone-200 min-h-screen pt-32 pb-20 px-6 md:px-12">
      ...
      <section className="max-w-7xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        {/* Aquí es donde mapearás tus productos del backend más adelante */}
        {[1, 2, 3, 4].map((item) => (
          <div key={item} className="group cursor-pointer">
            ...
            <h3 className="text-stone-800 font-medium text-sm tracking-wide">PRODUCTO EJEMPLO</h3>
            <p className="text-stone-400 text-sm italic">$120.00</p>
          </div>
        ))}
      </section>
    </div>
